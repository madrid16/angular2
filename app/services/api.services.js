...
var ApiService = (function () {
    ...
    ApiService.prototype.getCourses = function () {
        ...
        return this.http.get(url).toPromise().then(function (response) { return response.json(); }).catch(this.error);
    };
    ApiService.prototype.getCoursesSlow = function () {
        var _this = this;
        return new Promise(function (resolve) { return setTimeout(resolve, 2000); }).then(function () { return _this.getCourses(); });
    };
